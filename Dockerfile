...
ADD ./dedicated_billing /var/www/html

RUN mkdir -p /var/www/html/v2/backend/runtime \
    && mkdir -p /var/www/html/v2/backend/web/assets \
    && mkdir -p /var/www/html/v2/api/runtime \
    && mkdir -p /var/www/html/v2/api/web/assets \
    && mkdir -p /var/www/html/v2/frontend/runtime \
    && mkdir -p /var/www/html/v2/frontend/web/assets \
    && mkdir -p /var/www/html/v2/common/DynamicModels
